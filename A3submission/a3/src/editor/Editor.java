...
public class Editor extends Application {
   ...
   private void setupDictionary(final HTMLEditor htmlEditor, final Stage stage) {
      ...
      ImageView graphic = new ImageView(new Image("resources/dict.png", 24, 24, true, true));
      ...
      loadDict.setOnAction(new EventHandler<ActionEvent>() {
         ...
         public void handle(ActionEvent arg0) {
            ...
            if (editorModel.loadDictionary(dict)) for (Button b : controls) {
               b.setDisable(false);
            }
         }
      });
   ...
   private void setupSpellCheck(final HTMLEditor htmlEditor) {
      ToolBar bar = getToolBar(htmlEditor);
      ImageView graphic = new ImageView(new Image("resources/check.png", 24, 24, true, true));
      graphic.setEffect(new DropShadow());
      ...
      spellCheck.setOnAction(new EventHandler<ActionEvent>() {
         ...
         public void handle(ActionEvent arg0) {
            ...
            timer.setText("Spell check time: " + editorModel.getSpellCheckTime() + " μs.");
         }
      });
   }
   ...
   private void setupClearFormatting(final HTMLEditor htmlEditor) {
      ToolBar bar = getToolBar(htmlEditor);
      ImageView graphic = new ImageView(new Image("resources/cancel.png", 24, 24, true, true));
      graphic.setEffect(new DropShadow());
   ...
   private void setupSearch(final HTMLEditor htmlEditor) {
      ...
      ImageView graphic = new ImageView(new Image("resources/search.png", 24, 24, true, true));
      graphic.setEffect(new DropShadow());
      searchButton = new Button("", graphic);
      searchButton.setOnAction(new EventHandler<ActionEvent>() {
         @Override
         public void handle(ActionEvent arg0) {
            htmlEditor.setHtmlText(editorModel.search(searchBox.getText(), htmlEditor.getHtmlText()));
         }
      });
